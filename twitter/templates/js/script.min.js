...
window.onload=function(){if(void 0===e){var e={};e.name=document.querySelector("div.name.counter"),e.description=document.querySelector("div.description.counter"),e.location=document.querySelector("div.location.counter");var n={};n.name=document.querySelector("input.textbox.name"),n.description=document.querySelector("input.textbox.description"),n.location=document.querySelector("input.textbox.location"),n.name.addEventListener("keypress",function(){setTimeout(function(){e.name.innerHTML=n.name.value.length},1)}),n.name.addEventListener("change",function(){setTimeout(function(){e.name.innerHTML=n.name.value.length},1)}),n.name.addEventListener("paste",function(){setTimeout(function(){e.name.innerHTML=n.name.value.length},1)}),n.description.addEventListener("keypress",function(){setTimeout(function(){e.description.innerHTML=n.description.value.length},1)}),n.description.addEventListener("change",function(){setTimeout(function(){e.description.innerHTML=n.description.value.length},1)}),n.description.addEventListener("paste",function(){setTimeout(function(){e.description.innerHTML=n.description.value.length},1)}),n.location.addEventListener("keypress",function(){setTimeout(function(){e.location.innerHTML=n.location.value.length},1)}),n.location.addEventListener("change",function(){setTimeout(function(){e.location.innerHTML=n.location.value.length},1)}),n.location.addEventListener("paste",function(){setTimeout(function(){e.location.innerHTML=n.location.value.length},1)})}};
